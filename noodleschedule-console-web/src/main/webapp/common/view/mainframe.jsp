	...
	<div class="container">
		...
		<div class="menuer">
            <ul id="menu">
                ...
                <li><a href="#">任务</a>
                    <ul>
			        	<li><a href="#" onclick="javascript:addTab('mainframe_1_1', '任务配置', '<%=request.getContextPath()%>/view/console/job/job_main.jsp');">任务配置</a></li>
			      		<li><a href="#" onclick="javascript:addTab('mainframe_1_2', '执行机器', '<%=request.getContextPath()%>/view/console/executor/executor_main.jsp');">执行机器</a></li>
                   </ul>
                </li>
                <li><a href="#">监控</a>
                    <ul>
			        	<li><a href="#" onclick="javascript:addTab('mainframe_2_1', '任务状态', '<%=request.getContextPath()%>/view/monitor/job/job_status_main.jsp');">任务状态</a></li>
			        	<li><a href="#" onclick="javascript:addTab('mainframe_2_2', '详细日志', '<%=request.getContextPath()%>/view/monitor/job/view_log_main.jsp');">详细日志</a></li>
                   </ul>
                </li>
                <li><a href="#">报警</a>
                    <ul>
			        	<li><a href="#" onclick="javascript:addTab('mainframe_3_1', '任务报警', '<%=request.getContextPath()%>/view/alarm/job/job_alarm_main.jsp');">任务报警</a></li>
