...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		ijobcenterIE = $.browser.msie ? true:false;
		...
		if (ijobcenterIE && $.browser.version <= 6) {
		...
		tdc = ijobcenterIE ?  "class='ui-th-div-ie'" :"";
		...
		if(ijobcenterIE) { if(String(ts.p.height).toLowerCase() === "auto") { ts.p.height = "100%"; } }
		$(grid.bDiv)
			.append($('<div style="position:relative;'+(ijobcenterIE && $.browser.version < 8 ? "height:0.01%;" : "")+'"></div>').append('<div></div>').append(this))
