  ...
  <head>
    ...
    <script type="text/javascript">
		...
		function init() {
			...
			$('#list_left').jqGrid({
		   		url: '<%=request.getContextPath()%>/alarm/job/alarmpeople/queryincludepage',
				datatype: 'json',
				mtype: 'post',
			...
			$('#list_right').jqGrid({
		   		url: '<%=request.getContextPath()%>/alarm/job/alarmpeople/queryexcludepage',
				datatype: 'json',
				mtype: 'post',
				postData:{'input': jsonToString(paramObject)}, 
				colNames: [
		...
		function inserts() {
			...
			transaction({
				id: 'INSERTS',
				url: '<%=request.getContextPath()%>/alarm/job/alarmpeople/inserts',
				jsonSet: jsonSet
			});	
		}
		...
		function deletes() {
			...
			transaction({
				id: 'DELETES',
				url: '<%=request.getContextPath()%>/alarm/job/alarmpeople/deletes',
				jsonSet: jsonSet
			});	
		}
