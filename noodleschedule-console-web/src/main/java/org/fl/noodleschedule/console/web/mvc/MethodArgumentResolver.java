package org.fl.noodleschedule.console.web.mvc;
...
public class MethodArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public MethodArgumentResolver() {
		...
		jSONDeserializer.use(Integer.class, new MyTransformer());
	...
	private class MyTransformer implements ObjectFactory {
		...
		public Object instantiate(ObjectBinder context, Object value, Type targetType, Class targetClass) {
			Object object = null;
			if ((targetType.equals(byte.class) || targetType.equals(Byte.class)) && value.getClass().equals(String.class)) {
				if (value != null && !value.equals("")) {
					object = Byte.parseByte((String) value);
				}
			} else if ((targetType.equals(int.class) || targetType.equals(Integer.class)) && value.getClass().equals(String.class)) {
				if (value != null && !value.equals("")) {
					object = Integer.parseInt((String) value);
				}
			} else if ((targetType.equals(long.class) || targetType.equals(Long.class)) && value.getClass().equals(String.class)) {
				if (value != null && !value.equals("")) {
